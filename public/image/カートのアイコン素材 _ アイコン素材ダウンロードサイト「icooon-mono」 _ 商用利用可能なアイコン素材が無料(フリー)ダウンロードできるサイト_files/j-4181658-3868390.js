//Generated:2022-05-16 21:18:56// 6-254
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4181658 || '',
    guid: window.ftGUID_4181658 || '',
    confID: window.ftConfID_4181658 || '0',
    ftReturn: window.ftReturn_4181658 || '',
    keyword: window.ftKeyword_4181658 || '',
    ftId: window.ftId_4181658 || '',
    ftImpId: window.ftImp4181658 && window.ftImp4181658.impID || '',
    gdpr: window.ftImp4181658 && window.ftImp4181658.gdpr || '',
    gdpr_consent: window.ftImp4181658 && window.ftImp4181658.gdpr_consent || '',
    gdpr_pd: window.ftImp4181658 && window.ftImp4181658.gdpr_pd || '',
    us_privacy: window.ftImp4181658 && window.ftImp4181658.us_privacy || '',
    campaignID: '115846',
    cID: '157595',
    pID: '4181658',
    creativeID: '3868390',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115846&sid=18330&plc=4181658&num=&adid=&advid=&adsrv=29&btreg=4181658&btadsrv=flashtalking&crt=3868390&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["http://servedby.flashtalking.com/click/8/115846;4181658;3868390;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://www.adobe.com/jp/creativecloud/plans.html?sdid=GZKZY1B7&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?221610295-4181658;3868390;',
    centreAd: false,
    width: 160,
    height: 600,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/418/4181658/3868390/image/3868390.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115846;4181658;202;pixel;DV360;DV360FY20CCBEHInMarketJPDSKBAN160x600/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: "http://servedby.flashtalking.com/click/8/115846;4181658;3868390;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://www.adobe.com/jp/creativecloud/plans.html?sdid=GZKZY1B7&mv=display",
    divID: 'ftdiv4181658',
    altimgID: 'ftalt4181658',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4181658 && parseInt(window.ftImp4181658.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4181658') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4181658'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4181658").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4181658").style.display = "none";
		    }
		});
	}
}(ft4181658));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115846&l2=DV360&l3=4181658&l4=3868390&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115846&l2=DV360&l3=4181658&l4=3868390&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_4181658;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_4181658;
